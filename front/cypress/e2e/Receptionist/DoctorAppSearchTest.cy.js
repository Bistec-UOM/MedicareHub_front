describe('Doctor day appointment search list', () => {
    it('should display searched day appointments and render correctly', () => {  //check the applist renders correctly with correct data
       ...
       //intercept the actual url with fixture data
        ...
        cy.get('[data-testid="doctorapplist"]', { timeout: 10000 }) 
            ...
            cy.get('#doctorappsearch').type('David', { force: true });
