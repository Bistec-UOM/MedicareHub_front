    ...
    it('should display an error popup', () => {  //check the applist renders correctly with correct data
       ...
       //intercept the actual url with fixture data
        ...
        cy.get('[data-testid="doctorapplist"]', { timeout: 10000 }) 
          ...
          cy.get('[data-testid="doneicon"]').first().click();
          cy.get('[data-testid="confirmtext"]').should('contain','Are you sure you want to mark as completed the appointment?');

          cy.get('[data-testid="doneconfirm"').click();
