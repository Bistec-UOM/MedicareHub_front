        ...
        <div>
            <form>
                <div {...getRootProps()} className="dropbox">
                    ...
                    {isDragActive ? (
                        <div style={{ border: '3px dashed rgb(59, 135, 122)', color: 'rgb(59, 135, 122)', backgroundColor: 'white',padding:'1vh' }}>
                            <p>Drag 'n' drop some files here, or click to select files</p>
                        </div>
                    ) : (
                        <div style={{  backgroundColor: 'white',padding:'1vh',cursor:'pointer'}}>
                            <p>Drag 'n' drop some files here, or click to select files</p>
                        </div>
                    )}
                </div>
                ...
                <Button onClick={handleDropBoxClose}>Close</Button>
                </Grid>
            </form>
        </div>
    );
