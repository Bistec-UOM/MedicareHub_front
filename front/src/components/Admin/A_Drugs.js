...
const ADrugs = () => {
  ...
  const uniqueDrugTypes = drugTypes.reduce(
    (unique, item) =>
      unique.some((drug) => drug.name === item.name)
        ? unique
        : [...unique, item],
    []
  );
  ...
  return (
    <div>
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            ...
            <Typography fontSize={30} sx={{ marginTop: 4 }}>
      ...
      <Grid>
        <Typography fontSize={25} sx={{textAlign:'center',marginTop:'10vh'}}>Available Drug Count</Typography>
